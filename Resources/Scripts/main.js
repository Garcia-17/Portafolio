...
const html1 =
  "<img id='terminal' src='./Resources/Images/Terminal.png' alt='' /> <div id='projectsInfoContainer'> <h1 class='text' id='projectsTitle'> Sistema de almacenamiento de evidencia </h1> <div> <p class='text' id='projectDescription'> Frameworks: React native,Electron, FastAPI. </p> <p class='text' id='projectDescription'> Lenguajes: Python, Javascript, Typescript. </p> <p class='text' id='projectDescription'>Respositorios:</p> <a href='https://gitfront.io/r/Garcia/i6xjJ7oG9nqB/proyecto-embarques/' class='text' id='repButton' target='_blank' >Mobil app</a > <a href='https://gitfront.io/r/Garcia/i6xjJ7oG9nqB/proyecto-embarques/' class='text' id='repButton' target='_blank' >Desktop app</a > <p class='text' id='projectDescription'> Descripcion: Se desarollo una aplicacion para el registro de immagenes dentro de una terminal tc26 para posteriorente registrarlkas den tro de un servidor local, en el cual mediante una interfaz grafica que tammbien fue deesarrollado para este proposito se observa la recepcion de los archivos, se tuvo que adaptar el servidor a un equipo loical devbidop a las limitaciones dentro de el area de trabajo y los recursos disponibles. </p> </div>";
